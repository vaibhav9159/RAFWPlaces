pipeline 
{
 ...
 def dockerCommand = "docker run --name apitesting${BUILD_NUMBER} -e MAVEN_OPT='-Dsurefire.suiteXmlFiles=src/test/resources/testrunners/allTestsTestng.xml' vaibhavs07/apiplaces:latest"
